...
public class DebitATMCard extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.debit_atm_card);
        ...
        bb = (Button)findViewById(R.id.db);
        tv = (TextView)findViewById(R.id.vcard);

        bb.setOnClickListener(this);
        tv.setText(R.string.dc);
    }
